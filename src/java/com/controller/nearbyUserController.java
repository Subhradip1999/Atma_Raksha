 ...
 * @author u
 */
public class nearbyUserController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          if(imp.getFlag(profileId).equalsIgnoreCase("1")){
             // System.out.println("here--------------->");
            getUserLocation=imp.getNearUserAlarmData(profileId);
          }else{
              getUserLocation.add(user);
          }
